...
@section('content')
    <div class="card">
        ...
        <div class="card-body pt-0">
            <form action="{{route('cms.caracteristicas.update', $characteristic->id)}}" method="post">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$characteristic->description}}" class="form-control @error('description') is-invalid @enderror" id="description" name="description">
                            @error('description')
